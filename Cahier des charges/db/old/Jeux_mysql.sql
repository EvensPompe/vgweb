...
CREATE TABLE `JEU` (
  `id_jeu` VARCHAR(42),
  `nom_jeu` VARCHAR(42),
  `jour_de_sortie` VARCHAR(42),
  `mois_de_sortie` VARCHAR(42),
...
CREATE TABLE `EDITEUR/DEVELOPPEUR` (
  `id_edit` VARCHAR(42),
  `nom_edit` VARCHAR(42),
...
ALTER TABLE `JEU` ADD FOREIGN KEY (`id_edit`) REFERENCES `EDITEUR/DEVELOPPEUR` (`id_edit`);
...
ALTER TABLE `UTILISER` ADD FOREIGN KEY (`id_edit`) REFERENCES `EDITEUR/DEVELOPPEUR` (`id_edit`);