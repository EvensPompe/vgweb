...
export default {
  ...
  methods:{
    sendSubmit(e) {
      e.preventDefault();
      this.axios.post("http://51.91.156.10:3000/note/new",{note:this.note,critique:this.critique,fk_jeu:this.game.id,fk_utilisateur:VueJwtDecode.decode(this.$session.get('jwt')).id},{headers:{
